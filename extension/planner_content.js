...
(() => {
  ...
  function observe(){
    ...
    last={observation_id,question_key,identity,document_id:doc,question:stem.text||norm(document.title),tables:tableContext.tables,table_context_complete:tableContext.complete,slots,menus,navigation:navigation.slice(0,60),navigation_complete,feedback,page_state,enumeration,parts:partList,
