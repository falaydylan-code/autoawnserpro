...
async function settings() {
  const s = await chrome.storage.local.get(['backend', 'token', 'model', 'note', 'advance', 'auto_submit', 'screenshot_numbering', 'double_check', 'spend_limit', 'planner_enabled', 'check_work']);
  return {
    ...
    advance: s.advance === true, auto_submit: s.auto_submit === true, badges: s.screenshot_numbering === true, double_check: s.double_check !== false,
